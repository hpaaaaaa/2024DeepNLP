...
if __name__ == '__main__':
    if GEN_DATA:
        ...
        name1='郭靖'
        name2='黄蓉'
        words_similarity=word2vec_model.wv.similarity(name1, name2)
        print(f"词语1与词语2的语义相似度：{words_similarity}")
        ...
        # 计算段落相似度
        pra_similarity=word2vec_model.wv.wmdistance(test_paragraph1, test_paragraph2)
        #wmdistance比较语句之间的相似度，数值越大代表越不相似
        print(f"段落1与段落2的语义相似度：{pra_similarity}")
