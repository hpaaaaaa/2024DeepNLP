...
train_novel_path = './天龙八部train.txt'
test_novel_path = './天龙八部test.txt'
is_Train = False
char_key_dict_path = 'chinese_characters_3500.txt'
model_save_path = "./novel_creat_model.pkl"
model_save_path_pth = "./novel_creat.pth"
save_pred_novel_path = "./create_novel/pred_novel_" + str(int(round(time.time() * 1000000))) + ".txt"
pred_novel_start_text = '众人相顾愕然，没料想皇帝一句话不说，一口酒不饮，竟便算赴过了酒宴。'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sequence-length', type=int, default=50)  # sequence-length 每次训练多长的句子, default=50)
    ...
    if is_Train:
        ...
        neirong = predict(dataset, model, pred_novel_start_text, 100)
        print(neirong)
        # for i in range(1, 30):
